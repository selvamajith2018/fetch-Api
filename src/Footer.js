  ...
  function Footer() {
    ...
    return (
      <div className='bg-primary mt-3 pt-3'>
        <div className='row'>
            ...
            <div className='col-12 col-sm-3 col-md-3 col-lg-3'>
                    <h5>Social Media</h5>
                    <span><i class="fa-brands fa-facebook fa-lg"></i> &nbsp; <i class="fa-brands fa-instagram fa-lg"></i> &nbsp;<i class="fa-brands fa-square-twitter fa-lg"></i></span>
